...
import com.example.headyinterviewtest.Network.Urls;
...
public class UtilsModule {
    ...
    @Provides
    @Singleton
    IApiInterface getApiCallInterface(Retrofit retrofit) {
    ...
    @Provides
    @Singleton
    Repository getRepository(IApiInterface apiCallInterface) {
